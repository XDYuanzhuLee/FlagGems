...
def _batch_norm_with_update_kernel(
    ...
    """Forward kernel for _batch_norm_with_update.

    This kernel always updates running_mean and running_var (training mode).
    """
    feat_pid = tl.program_id(axis=0)

    # Training mode: compute mean and variance, update running stats
...
def _batch_norm_with_update(
    ...
    """Batch normalization with running stats update.

    This function always updates running_mean and running_var (training mode).
    It returns (output, mean, var, save_mean) where save_mean is empty for
    compatibility with the backward pass.
    """
