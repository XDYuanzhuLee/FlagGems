...
def batch_norm_with_update_kernel(
    ...
    running_mean_pointer = running_mean_ptr + feat_pid
    running_var_pointer = running_var_ptr + feat_pid
...
def _batch_norm_with_update(
    ...
    logger.debug("METAX GEMS _BATCH_NORM_WITH_UPDATE")
    ...
    # Return empty reserved tensor as the fourth output
