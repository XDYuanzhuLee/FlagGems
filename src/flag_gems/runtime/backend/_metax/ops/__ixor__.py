...
def bitwise_xor(A, B):
    logger.debug("METAX GEMS BITWISE_XOR")
...
def bitwise_xor_(A, B):
    logger.debug("METAX GEMS BITWISE_XOR_")
...
def bitwise_xor_scalar(A, B):
    logger.debug("METAX GEMS BITWISE_XOR SCALAR")
    return ixor_func_scalar(A, B)


def bitwise_xor_scalar_(A, B):
    logger.debug("METAX GEMS BITWISE_XOR SCALAR_")
    return ixor_func_scalar(A, B, out0=A)


def bitwise_xor_scalar_tensor(A, B):
    logger.debug("METAX GEMS BITWISE_XOR SCALAR TENSOR")
