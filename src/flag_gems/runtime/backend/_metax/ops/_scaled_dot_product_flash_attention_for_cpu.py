...
def _scaled_dot_product_flash_attention_for_cpu(
    ...
    logger.debug("METAX GEMS SCALED DOT PRODUCT FLASH ATTENTION FOR CPU")
    # shape constraints
    ...
    # For _scaled_dot_product_flash_attention_for_cpu, assume GQA is not enabled
    # or q_head_num == kv_head_num
    enable_gqa = False
...
# Register the implementation for CUDA backend
