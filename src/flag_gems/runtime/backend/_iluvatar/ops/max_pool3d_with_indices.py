...
@triton.autotune(
    configs=[
        ...
        triton.Config({"BLOCK_D": 8, "BLOCK_H": 16, "BLOCK_W": 8}, num_stages=3, num_warps=4),
        triton.Config({"BLOCK_D": 8, "BLOCK_H": 8, "BLOCK_W": 16}, num_stages=3, num_warps=4),
        triton.Config({"BLOCK_D": 16, "BLOCK_H": 16, "BLOCK_W": 8}, num_stages=2, num_warps=8),
        triton.Config({"BLOCK_D": 16, "BLOCK_H": 8, "BLOCK_W": 16}, num_stages=2, num_warps=8),
        triton.Config({"BLOCK_D": 8, "BLOCK_H": 16, "BLOCK_W": 16}, num_stages=2, num_warps=8),
        triton.Config({"BLOCK_D": 16, "BLOCK_H": 16, "BLOCK_W": 16}, num_stages=2, num_warps=8),
    ],
...
def max_pool3d_forward_kernel(
    ...
    output_block_ptr = (
        out_base_ptr + out_d_offsets[:, None, None] * out_h * out_w + out_h_offsets[None, :, None] * out_w + out_w_offsets[None, None, :]
    )
    indices_block_ptr = (
        indices_base_ptr + out_d_offsets[:, None, None] * out_h * out_w + out_h_offsets[None, :, None] * out_w + out_w_offsets[None, None, :]
    )
...
def max_pool3d_with_indices(
    ...
    logger.debug("ILUVATAR GEMS MAX_POOL3D_WITH_INDICES")
