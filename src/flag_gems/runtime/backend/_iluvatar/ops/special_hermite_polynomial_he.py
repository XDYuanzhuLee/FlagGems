...
def hermite_he_func(x, n):
    ...
    result = tl.where(n_int == 7, x3 * x2 * x2 - 21.0 * x3 * x2 + 105.0 * x3 - 105.0 * x_f32, result)
    # He_8 = x^8 - 28x^6 + 210x^4 - 420x^2 + 105
    result = tl.where(n_int == 8, x4 * x4 - 28.0 * x2 * x4 + 210.0 * x4 - 420.0 * x2 + 105.0, result)
    # He_9 = x^9 - 36x^7 + 378x^5 - 1260x^3 + 945x
    x5 = x4 * x_f32
    x6 = x4 * x2
    x7 = x6 * x_f32
    x8 = x6 * x2
    result = tl.where(n_int == 9, x8 * x_f32 - 36.0 * x6 * x_f32 + 378.0 * x4 * x_f32 - 1260.0 * x3 + 945.0 * x_f32, result)
    # He_10 = x^10 - 45x^8 + 630x^6 - 3150x^4 + 4725x^2 - 945
    result = tl.where(n_int == 10, x8 * x2 - 45.0 * x8 + 630.0 * x6 - 3150.0 * x4 + 4725.0 * x2 - 945.0, result)
