...
AVGPOOL3D_CONFIGS = [
    # Basic 3D case: 2x2x2 kernel, stride 2, padding 1
    ((4, 3, 8, 8, 8), (2, 2, 2), (2, 2, 2), (1, 1, 1), False, True, None),
    # Test count_include_pad=False
    ((4, 3, 8, 8, 8), (2, 2, 2), (2, 2, 2), (1, 1, 1), False, False, None),
    # Test ceil_mode
    ((2, 4, 7, 7, 7), (2, 2, 2), (2, 2, 2), 1, True, True, None),
    # Test divisor_override
    ((1, 1, 4, 4, 4), (2, 2, 2), (1, 1, 1), (0, 0, 0), False, True, 1),
    # Larger case from a typical 3D CNN
    ((1, 64, 16, 16, 16), (2, 2, 2), (2, 2, 2), 1, False, True, None),
    # No padding, count_include_pad=False
    ((2, 8, 8, 8, 8), (2, 2, 2), (2, 2, 2), (0, 0, 0), False, False, None),
    # Non-square padding
    ((2, 8, 8, 10, 12), (2, 2, 2), (2, 2, 2), (1, 0, 1), False, True, None),
]
